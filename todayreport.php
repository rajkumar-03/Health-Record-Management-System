  ...
  background-color: rgba(0,0,255,.25);
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">TODAYS SALES REPORT  </h4>
						<?php 
						$day=date('d');						  
				       $year=date('y');
			            $month=date('m');       
...
<div class='input-group' style='margin-bottom:10px;' >
          <span class='input-group-addon' style="height:-30%">Filter Report</span>
   <select  name='medstype'  id='schemefilter' class="schemefilter" style='height:30px; width: 100%' > 
            				        <option>ALL</option>           				     		                           
		                           <option>CASH</option>										             			 	
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
              ...
              <tr class="warning" style="font-weight: bold">
                ...
                <td >Quantity</td> 
                <td >Total Cost</td>               
                <td >Profit Per Element</td>
                <td >Profit Per Purchase</td>
                <td >Payment</td>
                ...
                <td >Time</td>
               	...
               	<?php 
                                     ...
                                     {                         $count=0;$profitss=0;$sales=0;
									             while($found = mysqli_fetch_array($retrieve))
	                                                {
                                                        $date = $found['Date']; $id=$found['Patientid'];	
														  $time=$found['Time']; $drug=$found['Drugname'];
														$quantity=$found['Quantity'];$unit=$found['Unitprice'];
													    $totalcost=$found['Totalcost'];$payment=$found['Payment'];
													    $consfee=$found['Consultation_fee'];$labfee=$found['Lab_fee']; 
														...
														$sqluser2 ="SELECT * FROM tbl_drugs WHERE Name='$drug' ";
	                                                          ...
	                                                          {
                                                                 $evening=$found['Marker'];	
                                                                 $dquantty=$found['Quantity'];
																 $pprice=$found['PurchasedPrice'];
																 $profitperdrug=$unit-($pprice/$dquantty);
																 $profitperdrug=round($profitperdrug,1);													   		                                                          
					                                    ...
					                                    $propp=$quantity*$profitperdrug;
														$profitss=$profitss+$propp;
